...
RequiredAssemblies = 'CustomLocation.Autorest/bin/Az.CustomLocation.private.dll'
...
FormatsToProcess = 'CustomLocation.Autorest/Az.CustomLocation.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('CustomLocation.Autorest/Az.CustomLocation.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Find-AzCustomLocationTargetResourceGroup', 'Get-AzCustomLocation', 
               'Get-AzCustomLocationEnabledResourceType', 
               'Get-AzCustomLocationResourceSyncRule', 'New-AzCustomLocation', 
               'New-AzCustomLocationMatchExpressionsObject', 
               'New-AzCustomLocationResourceSyncRule', 'Remove-AzCustomLocation', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Upgraded managed identity parameters.
